/**
 * Admin Payment Data Edge Function
 * 
 * Provides admin-level payment management including:
 * - List all transactions with appointment details
 * - Get revenue statistics (daily, weekly, monthly, yearly)
 * - Process refunds
 * - Get Stripe balance
 * 
 * Deployed location: supabase/functions/admin-payment-data/index.ts
 */
