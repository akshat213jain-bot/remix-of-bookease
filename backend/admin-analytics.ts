 ...
 * 
 * Provides system-wide analytics for administrators including:
 * - Overview statistics (appointments, providers, users)
 * - Booking trends over 30 days
 * - Provider performance metrics
 * - Time slot analytics (peak hours, busiest days)
 * 
 * Deployed location: supabase/functions/admin-analytics/index.ts
 */
