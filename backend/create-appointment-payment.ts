/**
 * Create Appointment Payment Edge Function
 * 
 * Creates a Stripe Checkout session for appointment payments.
 * 
 * Deployed location: supabase/functions/create-appointment-payment/index.ts
 */
