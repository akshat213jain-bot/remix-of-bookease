                ...
                <Card>
                    ...
                    <CardContent>
                       <div className="flex flex-col items-center justify-center text-center text-muted-foreground p-8 border-2 border-dashed rounded-lg">
                           <Image src="https://picsum.photos/seed/1/400/250" alt="Credit Card" width={400} height={250} className="mb-4 rounded-lg" data-ai-hint="credit card" />
...
// Dummy Label component to avoid creating a new file
